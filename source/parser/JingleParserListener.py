...
class JingleParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by JingleParser#stmtDisplay.
    def enterStmtDisplay(self, ctx:JingleParser.StmtDisplayContext):
        pass

    # Exit a parse tree produced by JingleParser#stmtDisplay.
    def exitStmtDisplay(self, ctx:JingleParser.StmtDisplayContext):
        pass
